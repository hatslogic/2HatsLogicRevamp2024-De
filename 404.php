...
<main class="page-wrap py-5">
        ...
        <section class="error-404 not-found relative pt-100 xs:pt-60 pb-100 md:pb-60">
		<div class=" container relative z-1">
                <div class="row p-80">
                    <div class="content-404" style="padding: 20px; text-align: center; width: 100%;">
                        <h1 class="mb-40" style="font-size: 8rem; color: #167297;">4<span style="color: #41afcb;">0</span>4</h1>
                        <h4 class=""><?php _e('PAGE NOT FOUND', 'sage'); ?></h4>
                        <p><?php _e('Sorry, but the page you were trying to view does not exist.', 'sage'); ?></p>
                        <div class="mb-10">
                            <a class="btn btn-404" href="<?php echo esc_url(home_url()); ?>"><?php _e('Back to home', 'sage'); ?></a>
                        </div>
                    </div>
                </div>
