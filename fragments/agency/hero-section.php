...
<section class="hero pt-60 overflow-hidden relative <?php echo $bg_class;?>">
                    ...
                    <div class="review-wrap bg-light-grey p-20 mt-40">
                        ...
                        <div class="google-rating flex justify-between align-center xs:wrap mt-15 xs:mt-10">
                            <div class="rating-score flex align-center gap-20">
                                ...
                                <?php } else { ?>
                                <img src="<?php echo get_template_directory_uri(); ?>/dist/dist/assets/img/rating/google-logo.svg"
                                ...
                                <?php } else { ?>
                                <img src="<?php echo get_template_directory_uri(); ?>/dist/dist/assets/img/rating/star.svg"
                ...
                <div class="consultation-wrap b-1 bc-hash solid bg-white p-50 xs:p-30">
                    ...
                    <div class="avatar-wrap flex align-center mt-30">
                        <?php if ($consultant['image']): ?>
                            <div class="img-wrap bg-light-grey w-px-75 h-px-75 max-w-px-75 min-w-px-75 xs:w-px-50 xs:h-px-50 xs:max-w-px-50 xs:min-w-px-50">
                               <?php
                                $cropOptions = [
                                    '(max-width: 768px)' => [34, 34],
                                    '(min-width: 769px)' => [90, 90],
    ...
    <div class="bg-shape absolute z-0 right-0 top-0 w-60  h-px-500 md:w-80">
        <picture class="shape w-100 absolute -top-10">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/shopware-bg.jpg" alt="laravel" width="100" height="100">
        </picture>
    </div>
</section>
