...
<section class="hero py-60 relative">
            ...
            <div class="col w-60 md:w-100">
                <div class="service-rating flex align-center gap-20 xs:wrap xs:gap-10">
                    <div class="logo flex gap-10">
                        <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/img/rating/google-logo.svg" class="w-px-100" alt="google" width="100"
                            height="100">
                ...
                <div class="service-header mt-30">
                    ...
                    <?php if ($cta): ?>
                    <div class="btn-group mt-30"> <a href="<?php echo $cta['url']; ?>" class="btn btn-primary"><?php echo $cta['title']; ?></a>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
                ...
                <div class="review-block mt-40 xs:mt-30 flex gap-20 w-90 xs:wrap xs:w-100">
                    <div class="avatar-wrap flex mt-30 align-center w-px-300 md:w-100">
                       <?php if($review['avatar']): ?>
                        <div class="img-wrap w-px-75 h-px-75 max-w-px-75 min-w-px-75 xs:w-px-50 xs:h-px-50 xs:max-w-px-50 xs:min-w-px-50 over overflow-hidden">
                        ...
                        <div class="author ml-20">
                            <div class="author-name fs-20 xs:fs-16 font-bold"><?php echo $review['name']; ?></div> <span
                                ...
                                <img src="<?php echo $review['rating']['url']?>" alt="star" class="w-px-100 xs:w-px-75" width="100"
                                    height="100">
                            </span>
                ...
                <div class="consultation-wrap b-1 bc-hash solid bg-white p-50 xs:p-30">
                    ...
                    <div class="avatar-wrap flex mt-30">
                        <div
                            ...
                            <img src="uploads/aneesh.jpg" alt="CEO" width="75" height="75">
                        </div>
                        <div class="author ml-30">
                            <div class="author-name font-bold">Aneesh Sreedharan</div> <span
                                class="designation font-light fs-15 lh-1-25 mt-5 inline-block">Founder & CEO,<br> 2Hats
                                Logic Solutions</span>

                        </div>
                    </div>
                    <div class="form-wrap mt-20">
                        <div class="form form-lined">
                            <div class="flex">
                            ...
                            <div class="btn-group mt-20">
                                <button type="submit" aria-label="submit" class="btn btn-secondary">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-shape absolute z-0 right-0 top-0 w-60 h-px-500 md:w-80">
        <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shape-01.png" srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shape-012x.png 2x" class="shape w-100 absolute top-0"
            alt="shopware" width="100" height="100">
    </div>
</section>