...
<section class="hero overflow-hidden pt-60 relative <?php echo $bg_class; ?>">
    ...
    <div class="bg-shape absolute z-0 right-0 top-0 w-60  h-px-500 md:w-80">
        <picture class="shape w-100 absolute -top-10">
            <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg.webp 1x, <?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg2x.webp 2x" media="(min-width: 768px)" type="image/webp">
            <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg-mobile.webp 1x, <?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg-mobile.webp 2x" media="(max-width: 767px)" type="image/webp">
            <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg2x.jpg 2x" media="(min-width: 768px)" type="image/jpg">
            <source srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg-mobile.jpg 1x, <?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg-mobile.jpg 2x" media="(max-width: 767px)" type="image/jpg">
            <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/laravel-bg.jpg" alt="shopware" width="100" height="100">
        </picture>
    </div>
</section>