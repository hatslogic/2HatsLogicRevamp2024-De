...
<section class="hero overflow-hidden py-60 relative">
                    ...
                    <div class="flex align-center md:wrap">
                        <div class="col w-60 md:w-100">
                            ...
                            <div class="service-header mt-30">
                                ...
                                <div class="btn-group mt-40"> <a href="<?php echo $cta['url']; ?>" class="btn btn-moonstone"><?php echo $cta['title']; ?></a>
                        ...
                        <div class="col w-40 md:w-100 md:mt-40">
                            <div class="consultation-wrap b-1 bc-hash solid bg-white p-50 xs:p-30">
                                ...
                                <?php if ($consultant['image']): ?>
                                    <div class="img-wrap w-px-75 h-px-75 max-w-px-75 min-w-px-75 xs:w-px-50 xs:h-px-50 xs:max-w-px-50 xs:min-w-px-50">
                                        <img src="<?php echo $consultant['image']['url']; ?>" alt="consultant" width="75" height="75">
                                    </div>
                                <?php endif; ?>
                                <?php if ($consultant['name'] || $consultant['desig']): ?>
                                    <div class="author ml-30">
                                        <div class="author-name font-bold"><?php echo $consultant['name'] ?></div><span class="designation font-light fs-15 lh-1-25 mt-5 inline-block"><?php echo $consultant['desig']; ?></span>
                ...
                <div class="background-shape absolute z-0 right-0 top-0 w-60 h-px-500 md:w-80">
                    <img src="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/shopware-bg.jpeg" srcset="<?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/shopware-bg.jpeg, <?php echo get_template_directory_uri(); ?>/dist/assets/img/shapes/shopware-bg2x.jpeg 2x" class="shape w-100 absolute top-0" alt="shopware" width="100" height="100">
                </div>
            </section>