                ...
                <div class="col card xs:mt-20">
                    <div class="technology">
                        <div class="logo-wrap flex align-center">
                            <img src="<?php echo $technology['image']['url']; ?>" loading="lazy" alt="<?php echo $technology['label']; ?>" width="100px" height="100px" class="transition">
                        </div>
                        <div class="info mt-30">
                            ...
                            <a href="<?php echo $technology['read_more']['url']; ?>" aria-label="<?php echo $technology['read_more']['label']; ?>" class="link link-primary"><?php echo $technology['read_more']['title']; ?><i class="icomoon icon-chevron_right"></i></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
