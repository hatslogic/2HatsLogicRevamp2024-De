        ...
        <div class="content mt-50 gap-40 sm:mt-30">
            <div class="flex nowrap sm:wrap justify-between scroll-x">
                ...
                <div class="col sm:w-50 pr-40 sm:pr-20">
                    <div class="count font-light c-primary"><span class="digit transition"
                            data-target="<?php echo $item['count']; ?>">0</span><?php echo $item['suffix']; ?></div>
                    <p class="mt-10"><?php echo $item['label']; ?></p>
                </div>
                <?php endforeach ?>
            </div>
        </div>
