        ...
        <?php if($sticky['headline']): ?>
            <div class="col relative">
                <div class="sticky headline pb-0">
                    ...
                    <?php endif; ?>
                    <?php if($sticky['link']): ?>
                          <a href="<?php echo $sticky['link']['url']; ?>" aria-label="<?php echo $sticky['link']['title']; ?>" class="btn btn-primary-outline"><?php echo $sticky['link']['title']; ?></a>
                    <?php endif; ?>
                        </div>
                </div>
            </div>
            ...
            <?php
                    ...
                    $classes = ($key == count($items) - 1) ? 'xs:pt-60 xs:pb-0 pb-0' : 'pb-150 xs:pt-60 xs:pb-60 pb-200';
                ?>
                <div class="service bg-light-grey relative top-0 pt-0 xs:pt-0 xs:pb-40 pl-50 xs:pl-0 <?php echo $classes; ?>">
                    ...
                    <?php echo apply_filters('the_content', $item['content']); ?>
                            <?php if($item['link']): ?>
                          <a href="<?php echo $item['link']['url']; ?>" aria-label="<?php echo $item['link']['title']; ?>" class="link link-primary"><?php echo $item['link']['title']; ?> <i class="icomoon icon-chevron_right"></i></a>
                          <?php endif; ?>
                        </div>
                        <?php endif; ?>
                </div>
