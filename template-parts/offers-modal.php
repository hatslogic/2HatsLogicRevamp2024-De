<?php
$offers_image = get_field('offers_image', 'option');
$offers_image_mobile = get_field('offers_image_mobile', 'option');
$form_shortcode = get_field('offers_form_shortcode', 'option');
$get_dir = get_template_directory_uri();
?>

<div id="offers" class="modal fixed get-a-quote bg-overlay inset-0 z-14 h-100 w-100 transition">
    <div class="container h-100 xs:p-0">
        <div class="flex align-center h-100">
            <div class="flex xs:wrap w-100 h-90 xs:h-100 align-center md:align-start relative bg-white z-1 xs:scroll-y">
                ...
                <button class="btn btn-secondary absolute xs:fixed z-1 top-20 right-20 close" onclick="closeModal('offers')">
                ...
                <div class="col w-50 h-100 xs:w-100 xs:h-50 md:hidden">
                    ...
                    <?php
                        ...
                        ?>
                    <?php echo hatslogic_get_attachment_picture($offers_image['ID'], $cropOptions, $attributes); ?>
