...
<?php if($newsletter_image && $newsletter_image_mobile): ?>
    <picture class="h-100 w-50 absolute top-0 sm:w-100 sm:relative">
                         <source media="(min-width: 1680px)"  srcset="<?php echo $newsletter_image['sizes']['img_2000x1334']; ?>" type="image/webp">
                        <source media="(min-width: 1536px)" srcset="<?php echo $newsletter_image['sizes']['img_2000x1334']; ?>" type="<?php echo $newsletter_image['mime_type']; ?>">
                        <source media="(min-width: 991px)" srcset="<?php echo $newsletter_image_mobile['sizes']['img_652x874']; ?>" type="image/webp">
                        ...
                        <img src="<?php echo $newsletter_image['sizes']['img_2000x1334']; ?>" loading="lazy" class="h-100 cover" alt="newsletter" width="800px" height="540px">
                    </picture>
                    <?php endif; ?>
