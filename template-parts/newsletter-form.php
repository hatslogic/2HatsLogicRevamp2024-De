...
<?php if($newsletter_image && $newsletter_image_mobile): ?>
    ...
    <source media="(min-width: 768px)"  srcset="<?php echo $newsletter_image['sizes']['img_2000x1334']; ?>" type="image/webp">
    <source media="(min-width: 768px)" srcset="<?php echo $newsletter_image['sizes']['img_2000x1334']; ?>" type="<?php echo $newsletter_image['mime_type']; ?>">
