<?php 
$testimonials = get_field('testimonials_with_rating');
// $bg_class = $testimonials['bg_enabled'] ? ' bg-light-grey' : 'b-white  shadow-rating'; 
?>

<?php if ($testimonials['posts']): ?>
    <section class="testimonials animate pt-30 pb-30">
        <div class="container">
            <div class="title"> 
                <span class="headline c-title-grey font-bold"><?php echo $testimonials['headline'] ?></span>
                                    ...
                                    <?php if( $rating ):?>
                                        <div class="google-rating flex justify-between align-center xs:wrap mt-15 xs:mt-10 w-100">
                                            <div class="rating-score flex align-center gap-20">
                                                <img src="<?php echo $rating['url']; ?>"
                                                    alt="star" class="w-px-90"
                                                    width="90" height="18">
                                            </div>
                                        </div>
                                    <?php endif;?>
