  ...
  <div class="w-100">
        ...
        <?php if (have_rows('toc_block')): ?>
          <div class="content mt-20">
            <ul class="fs-16 pl-15">
              <?php while (have_rows('toc_block')): the_row(); ?>
                <li class="mb-15">
    ...
    <div class="content p-30 md:p-20 mt-30 b-1 solid bc-hash">
      ...
      <div class="content mt-40"> 
        ...
        ?>
        <a href="<?php echo esc_url($link_url); ?>" class="no-decoration bc-primary w-100 flex align-center justify-between" aria-label="Click here to book a free 30 min call">
      ...
      <div class="w-100 py-30 md:pb-0">
        <picture>
          <source srcset="<?php echo $image['url'] ?>" type="image/webp">
            ...
            <img src="<?php echo $image['url'] ?>" loading="lazy" alt="Sidebar image" width="347px" height="335px" class="transition" />
        </picture>
      </div>
    </div>
    <?php endif; ?>
