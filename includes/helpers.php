...
function app_render_page_case_study_detail()
{
    if (!$sections = get_field('case_study_sections')) {
        return;
    }
    ...
    foreach ($sections as $section_index => $section) {
        ...
        app_render_fragment('case_study_detail'.DIRECTORY_SEPARATOR.$section_slug, compact('section_index', 'section_slug', 'section'));
    }
}
...
function app_render_page_team()
{
    if (!$sections = get_field('team')) {
        return;
    }
...
function app_render_page_packages()
{
    if (!$sections = get_field('packages')) {
        return;
    }
    ...
    foreach ($sections as $section_index => $section) {
        ...
        app_render_fragment('packages'.DIRECTORY_SEPARATOR.$section_slug, compact('section_index', 'section_slug', 'section'));
    }
}