...
$modal_id = get_query_var('cta_modal_id', 'popup-cta-download-' . uniqid());
$title = get_query_var('cta_title', 'Download Guide');
$content = get_query_var('cta_content', 'Get our comprehensive guide delivered to your inbox.');
$download_file = get_query_var('cta_download_file', '');
$newsletter_tags = get_query_var('cta_newsletter_tags', 'general');
?>
                    ...
                    <div class="form-wrap w-100">
                        <div class="text-center">
                            <div class="w-100 flex justify-center mb-35">
                                <img src="<?php echo $get_dir; ?>/dist/assets/img/newsletter-mail.svg" alt="Download" width="67" height="67" class="w-100 max-w-px-67 max-h-px-67">
                            </div>
                        ...
                        <div class="content">
                            <div class="form form-lined mt-25">
                                <form class="download-form" data-type="download" data-modal-id="<?php echo esc_attr($modal_id); ?>">
                                    ...
                                    <div class="form-group mt-20">
                                        <label class="checkbox-label">
                                            ...
                                            <span><?php echo __('Subscribe to our newsletter for more insights', 'app'); ?></span>
                                        </label>
                                    </div>
                                    <div class="form-group mt-20">
                                        <div class="cf-turnstile"></div>
                                    </div>
                                    <input type="hidden" name="download_file" value="<?php echo esc_attr($download_file); ?>">
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 mt-20"><?php echo __('Download Guide', 'app'); ?></button>
