...
<div class="container flex gap-40 md:gap-10 align-start md:wrap">
    <div class="w-70 md:w-100 mt-60 sm:mt-40 xs:mt-30">
        <div class="grid grid-2 md:grid-2 xs:grid-1 cg-30 rg-50 md:rg-30 w-100 mb-50 grid grid-2 md:grid-2 xs:grid-1 cg-40 rg-60 md:rg-40">
            <?php
                        ...
                        <a href="<?php the_permalink(); ?>" class="item">
                            <?php if (has_post_thumbnail()):
                                ...
                                <picture>
                                    ...
                                    <img src="<?php echo esc_url($featured_image); ?>" loading="lazy" alt="Blog" width="498"
    ...
    <div class="w-30 md:w-100 pl-30 b-0 bl-1 solid bc-hash md:pl-30 md:mt-30 md:b-1 solid bc-hash md:p-30 sticky top-120 mt-60 sm:mt-40 xs:mt-30">
